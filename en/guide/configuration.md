> Timeline Canvas uses a seconds-based relative time model. For the most accurate configuration types, refer to the TypeScript definitions: see [Type Definitions](/timeline-canvas/en/api/timeline/types.md).
